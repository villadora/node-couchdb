# Node Couchdb Client [![NPM version](https://badge.fury.io/js/node-couchdb.svg)](http://badge.fury.io/js/node-couchdb) [![Build Status](https://travis-ci.org/villadora/node-couchdb.png)](https://travis-ci.org/villadora/node-couchdb) [![Coverage Status](https://coveralls.io/repos/villadora/node-couchdb/badge.png)](https://coveralls.io/r/villadora/node-couchdb)
