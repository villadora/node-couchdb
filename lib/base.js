...
function RequestBase(options) {
    ...
    this.options.requestOpts = _.defaults(this.options.requestOpts || {}, {
        method: 'GET',
        json: true
    });
}
...
RequestBase.prototype.request = function() {
    if (!this.__request__) {
        this.__request__ = require('request');
    }

    return this.__request__.apply(thi, arguments);
};
...
RequestBase.prototype._request = function(url, options, callback) {
    ...
    return this.__request__(opt, function(err, res, body) {
