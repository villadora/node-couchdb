...
_.extend(Database.prototype, {
    ...
    doc: function(doc, options) {
        return new Document(this.dburl, doc, options || this.options);
    },
    local: function(options) {
        return new Local(this.dburl, options || this.options);
    },
    design: function(designName, options) {
        return new DesignDoc(this.dburl, designName, options || this.options);
    ...
    allDocs: function(skip, limit, options, callback) {
        if (arguments.length === 0) {
            var self = this,
                executor = new Executor('skip', 'limit', 'descending', 'endkey', 'starkey', 'endkey_docid', 'startkey_docid',
                    'group', 'group_level', 'include_docs', 'inclusive_end', 'key', 'reduce', 'stale');
            executor.execute = function(callback) {
                self._get(self.dburl + '/_all_docs?' + encodeOptions(this.options), function(err, body) {
