...
_.extend(Document.prototype, {
    ...
    open: function(options, callback) {
        ...
        var url = this.dburl + '/' + encodeURIComponent(this._id) + '?' + qs.stringify(options || {});
    ...
    save: function(batch, callback) {
        ...
        self._put(this.dburl, +(batch ? ('?' + qs.stringify({
            batch: 'ok'
        })) : ''), {
    ...
    copy: function(id, options, callback) {
        ...
        options = options || {};
        this._copy(this.dburl + '/' + this._id + (options.from_rev ? ('?' + qs.stringify({
